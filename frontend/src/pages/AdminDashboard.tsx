...
function AdminDashboard() {
    ...
    const abnormalStopParcels = parcels.filter(p => p.abnormalStop).length;
        ...
        <div className="min-h-screen bg-[#111F35] text-white py-8 px-4">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-2 md:grid-cols-6 gap-4 mb-8">
                    ...
                    <div className="bg-gradient-to-br from-[#111F35] to-[#8A244B] border border-[#8A244B] rounded-xl p-6 shadow-lg hover:border-[#F63049] transition-all duration-300">
                        <div className="text-3xl font-bold text-[#F63049] mb-2">{abnormalStopParcels}</div>
                        <div className="text-sm text-gray-300">Abnormal Stops</div>
                    </div>
                </div>
                        ...
                        <table className="w-full">
                            <thead>
                                <tr className="bg-[#8A244B] bg-opacity-30 border-b border-[#8A244B]">
                                    ...
                                    <th className="px-6 py-4 text-left text-sm font-semibold text-gray-300">AI Alerts</th>
                            ...
                            <tbody>
                                {filteredParcels.map((parcel, index) => (
                                    ...
                                    >
                                        ...
                                        <td className="px-6 py-4">
                                            {parcel.abnormalStop ? (
                                                <span className="flex items-center text-[#F63049] text-sm font-semibold animate-pulse">
