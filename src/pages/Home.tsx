      ...
      <section className="py-16 px-4 bg-gradient-to-b from-[#111F35] to-[#8A244B] bg-opacity-20">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {/* Feature 1 */}
            <div className="bg-[#111F35] border border-[#8A244B] rounded-xl p-8 hover:border-[#F63049] transition-all duration-300 shadow-lg hover:shadow-2xl">
              <div className="w-14 h-14 bg-gradient-to-br from-[#F63049] to-[#D02752] rounded-lg flex items-center justify-center mb-4">
